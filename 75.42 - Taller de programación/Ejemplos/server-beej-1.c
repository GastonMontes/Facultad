...
#define MYPORT 3490    // Puerto al que conectarán los usuarios

#define BACKLOG 10     // Cuántas conexiones pendientes se mantienen en cola
...
int main(void)
{
    ...
    struct sockaddr_in their_addr; // información sobre la dirección del clientez
    int sin_size;
    struct sigaction sa;
    int yes = 1;
    ...
    my_addr.sin_family = AF_INET; // Ordenación de bytes de la máquina.
